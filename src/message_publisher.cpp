...
void MessagePublisher::defineRosStandardPublishers(rclcpp::Node& ref_ros_node_handle, bool odom_enable)
{
  ...
  {
    m_temp_pub_     = ref_ros_node_handle.create_publisher<sensor_msgs::msg::Temperature>("sbg/ros/temp", m_max_messages_);
  }
  else
  {
  ...
  {
    m_velocity_pub_ = ref_ros_node_handle.create_publisher<geometry_msgs::msg::TwistWithCovarianceStamped>("sbg/ros/twist_with_covariance_stamped", m_max_messages_);
  }
  else
  {
  ...
  {
    m_fluid_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::FluidPressure>("sbg/ros/pres", m_max_messages_);
  }
  else
  {
  ...
  if (m_sbgEkfNav_pub_)
  {
    m_pos_ecef_pub_ = ref_ros_node_handle.create_publisher<geometry_msgs::msg::PointStamped>("sbg/ros/pos_ecef", m_max_messages_);
  }
  else
  {
  ...
  {
    m_utc_reference_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::TimeReference>("sbg/ros/utc_ref", m_max_messages_);
  }
  else
  {
  ...
  if (m_sbgGpsPos_pub_)
  {
    m_nav_sat_fix_pub_ = ref_ros_node_handle.create_publisher<sensor_msgs::msg::NavSatFix>("sbg/ros/nav_sat_fix", m_max_messages_);
  }
  else
  {
  ...
  if (odom_enable)
  {
    ...
    {
      m_odometry_pub_ = ref_ros_node_handle.create_publisher<nav_msgs::msg::Odometry>("sbg/ros/odometry", m_max_messages_);
    }
    else
    {
